...
const Footer = () => {
  return (
    <footer className="w-full border-t-2 border-yellow-800/20 border-t border-cyan-900/50 bg-slate-950 flex justify-between items-center px-12 py-8 mt-auto z-50 lg:ml-64">
